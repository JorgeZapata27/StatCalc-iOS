...
class FAVGTI: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func buttonPressed(_ sender: UIButton) {
        if self.textField1!.text! == "" || self.textField2!.text! == "" || self.textField3!.text! == "" {
            ...
            let P = Float(self.textField1.text!)!
            let A = Float(self.textField2.text!)!
            let E = Float(self.textField3.text!)!
            let P1 = (P + A)
            let P2 = (P + A + E)
            print(P1)
            print(P2)
            ...
            self.performSegue(withIdentifier: "calcFACVG", sender: self)
        }
    }
    
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if segue.identifier == "calcFACVG" {
